...
The website uses `/api/config.js` to expose only the public Supabase URL and publishable/anon key to the static frontend. No Supabase secret key is exposed.
